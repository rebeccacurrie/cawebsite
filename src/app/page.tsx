    ...
    <div className="min-h-screen bg-pink-100 p-8">
      <main className="max-w-4xl mx-auto bg-white rounded-lg shadow-lg overflow-hidden">
        ...
        <div className="p-6 grid grid-cols-1 md:grid-cols-2 gap-6">
          <section className="bg-yellow-100 p-4 rounded-lg shadow relative">
          ...
          <section className="bg-blue-100 p-4 rounded-lg shadow col-span-full">
          ...
          <section className="bg-pink-200 p-4 rounded-lg shadow relative col-span-full">
